...
extension UserModel {
    static let mockUsers: [UserModel] = [
        ...
        UserModel(image: "image2.png", name: "Bob Johnson", email: "bob.johnson@example.com", role: ["Usuario", "Administrador"], date: "2023-12-15"),
        UserModel(image: "image3.png", name: "Carol Williams", email: "carol.williams@example.com", role: ["Moderador"], date: "2023-11-30"),
        UserModel(image: "image4.png", name: "David Brown", email: "david.brown@example.com", role: ["Administrador", "Usuario"], date: "2023-10-25"),
